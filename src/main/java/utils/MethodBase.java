...
//    public static void downarrowKey() throws Exception
//    {
//        re = new Robot();
//        re.keyPress(KeyEvent.VK_PAGE_UP );
//        re.keyRelease(KeyEvent.VK_PAGE_UP);
//    }
    ...
    public static void clickText_ByID(String locator,String inputText) {
    ...
    public static void selectdown() throws Exception
    {
        re = new Robot();
        re.keyPress(KeyEvent.VK_KP_DOWN);
        re.keyRelease(KeyEvent.VK_KP_DOWN);
    }
...
//    public static void setText_ByVisibletext_ID(String locator) {
//        getDriver().findElement(By.xpath(locator)).isSelected();
//    }

    public static void selectMaterialDrop(String locator, String text) {
        Select dropdown = new Select(getDriver().findElement(By.xpath(locator)));
        PageBase.staticWait(6);
        dropdown.selectByVisibleText(text);
    }

    public static void setKey_ByXpath(String locator,Keys Text) {
    ...
    public static void clear_ById(String locator,String inputText) {

        getDriver().findElement(By.id(locator)).clear();
        getDriver().findElement(By.id(locator)).sendKeys(inputText);
    }

    public static void clear_ByXpath(String locator,String inputText) {
    ...
    public static void setDropDownOption(String locator,String option) {
        Select dropDownOption = new Select(getDriver().findElement(By.id(locator)));
        dropDownOption.selectByVisibleText(option);
    }

    public static void selectDropDown01( String locator,String text) {
        Select dropdown = new Select(getDriver().findElement(By.xpath(locator)));
        getDriver().findElement(By.xpath(locator)).click();
        dropdown.selectByVisibleText(text);
    }

//    public static void clickDropDownconfig(String locator) {
//        Select dropdown = new Select(getDriver().findElement(By.xpath(locator)));
//        getDriver().findElement(By.xpath(locator)).click();
//
//      dropdown.selectByVisibleText("test5");
//    }
    ...
    public static void   get_Text_string (String locator , String inputtext) {
         getDriver().findElement(By.xpath(locator)).sendKeys(inputtext);
    ...
    public static void clear_check(String locator){
        getDriver().findElement(By.xpath(locator)).click();
        getDriver().findElement(By.xpath(locator)).clear();
