...
//        MethodBase.assertEqual_T
//        ext_ByXpath("/html/body/div[6]/div/div[2]/div/div[2]/div[2]/form/div[1]/div[2]/div[1]/div/div[2]", "rawMaterial can't be empty");//rawMaterial can't be empty
...
//        MethodBase.click_ByXpath("/html/body/div[7]/div/div[2]/div/div[2]/div[1]/div/div/i");//close
        ...
        MethodBase.hitEnter();
        PageBase.staticWait(5);
        MethodBase.setText_ByXpath("//*[@id=\"finishProductCode\"]","5");//sample code
        PageBase.staticWait(5);
        MethodBase.click_ByXpath("//*[@id=\"date\"]/div/input");//Click Calender
        PageBase.staticWait(5);
        MethodBase.hitEnter();
...
//        MethodBase.click_ByXpath("/html/body/div[2]/div/div/div/div/div/button[2]");//clear
        ...
        PageBase.staticWait(5);
        PageBase.staticWait(5);
//        MethodBase.click_ByXpath("/html/body/div[1]/div/section/section/main/div/div[2]/div[1]/div/div/div/div[2]/div/div[2]/table/tbody/tr[1]/td[9]/span/a[2]/a/i");//delete
//        PageBase.staticWait(5);
//        MethodBase.click_ByXpath("/html/body/div[7]/div/div/div/div[2]/div/div/div[2]/button[2]");//delete ok btn
//        PageBase.staticWait(10);
//        LOGGER.info("Delete checked");
